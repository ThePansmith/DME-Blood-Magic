...
public class GuiDigitalAgonizer extends GuiMachine {
    ...
    private final ItemStack currentModel; // Data Model currently inside Agonizer
    ...
    private final boolean redstoneDeactivated = false; // Is Agonizer chamber deactivated by redstone signal?
